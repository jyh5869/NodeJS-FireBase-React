...
movies_query  = movies_ref.order_by("release_date").limit(100)  # 개봉일 기준 limit의 레코드 호출 쿼리 작성
credits_query = credits_ref.order_by("release_date").limit(100) # 개봉일 기준 limit의 레코드 호출 쿼리 작성
